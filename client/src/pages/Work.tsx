          ...
          {isLoading ? (
            ...
            <div className="flex flex-col gap-8">
              {projects.map((project) => {
                ...
                return (
                  <article key={project.id} className="group rounded-3xl border border-border bg-card overflow-hidden hover:border-foreground/20 transition-colors">
                      ...
                      <div className="relative min-h-[300px] xl:min-h-[480px] bg-muted overflow-hidden">
                        {project.imageUrl ? (
                          ...
                          <div
                            ...
                            style={{ background: `linear-gradient(135deg, ${project.iconColor ?? "#2b7fff"}22 0%, ${project.iconColor ?? "#2b7fff"}44 100%)` }}
                          >
                            <div className="absolute inset-0 flex items-center justify-center">
                              <div className="text-8xl font-black opacity-10 text-foreground">{project.title.charAt(0)}</div>
                            </div>
                          </div>
                        )}
                      </div>
