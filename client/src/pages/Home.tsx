        ...
        <div className="flex flex-col justify-between p-8 xl:p-12">
          <div className="flex flex-col gap-5">
            ...
            {project.problemStatement && (
              <div className="flex flex-col gap-2">
                ...
                <blockquote className="border-l-4 border-foreground pl-4 text-sm text-foreground italic leading-relaxed">
                  "{project.problemStatement}"
                </blockquote>
              </div>
            )}
          ...
          <div className="flex items-center justify-between pt-6 mt-6 border-t border-border">
            ...
            <Link
              ...
              data-testid={`view-case-study-${project.id}`}
            >
              View Case Study
        ...
        <div className="relative min-h-[300px] xl:min-h-[480px] bg-muted overflow-hidden">
          {project.imageUrl ? (
            ...
            <div
              ...
              style={{
                background: `linear-gradient(135deg, ${project.iconColor ?? "#2b7fff"}22 0%, ${project.iconColor ?? "#2b7fff"}44 100%)`,
              }}
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-6xl xl:text-8xl font-black opacity-10 text-foreground select-none">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start">
            ...
            <div className="flex flex-col gap-8 animate-fade-up">
              ...
              <p className="text-lg text-white/60 max-w-lg leading-relaxed">
                Specializing in mobile apps, SaaS products, and design systems that drive business results through research-driven design.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Link
                  href="/contact"
                  className="flex items-center gap-2 border border-white/20 text-white px-6 py-3 rounded-xl hover:bg-white/5 transition-colors"
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t border-white/10">
                <div>
                  <p className="text-3xl font-black text-white">{yearsExp}+</p>
                  <p className="text-sm text-white/50 mt-1">Years Experience</p>
                </div>
                <div>
                  <p className="text-3xl font-black text-white">{projectsDone}+</p>
                  <p className="text-sm text-white/50 mt-1">Projects Completed</p>
                </div>
                <div>
                  <p className="text-3xl font-black text-white">{happyClients}+</p>
      ...
      <section className="bg-muted/30 border-y border-border py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-4xl lg:text-5xl font-black text-foreground">Why Work With Me</h2>
            <p className="mt-3 text-lg text-muted-foreground max-w-lg mx-auto">
              I combine design thinking with business strategy to create products that users love and companies profit from
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {(whyWorkCards.length > 0 ? whyWorkCards : [
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-12">
              {trustedCompanies.map((company: string) => (
                <span key={company} className="text-xl lg:text-2xl font-black text-foreground/30 hover:text-foreground/60 transition-colors">
                  {company}
                </span>
              ))}
            </div>
